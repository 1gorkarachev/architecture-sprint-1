...
function AddPlacePopup({ isOpen, onAddPlace, onClose }: { isOpen: boolean, onAddPlace: () => void, onClose: () => void}) {
  ...
  function handleLinkChange(e: { target: { value: React.SetStateAction<string>; }; }) {
